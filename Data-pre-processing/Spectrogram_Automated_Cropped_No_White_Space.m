...
D = 'C:\Users\balu1\Desktop\Noise Classification\Noisy_created_file_06_04_21\train\-15dB'; %% PATH FOR INPUT AUDIO FILES
...
for k = 1:N
    F = fullfile(D,S(k).name);
     [x, fs] = audioread(F);	% load an audio file
...
path='C:\Users\balu1\Desktop\Noise Classification\Noisy_created_file_06_04_21\train\-15dB\-15dB'; %%DESTINATION FOLDER PATH FOR GRAPHS
exportgraphics(figure(3),fullfile(path,['sp' num2str(k) '_train_sn-15.png']))




% saveas(figure(3),fullfile(path,['sp' num2str(k) '_airport_sn10.png']));
